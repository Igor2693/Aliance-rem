...
<body>
  ...
  <header class="header-about <?= $header_style;?> <?= $header_fabric;?> ">
    <div class="container">
      <div class="about-content">
        ...
        <ul class="breadcrumb">
          <li class="breadcrumb-list">
            <a href="/index.php" class="breadcrumb-link-1">Главная</a>
          </li>
          <li class="breadcrumb-list">
            <div class="dash"></div>
          </li>
          <?php
          if (!empty($breadcrumb_avtohim)) {
            echo '<li class="breadcrumb-list">
            <a href="/contracts.php" class="breadcrumb-link-1">'. $breadcrumb_avtohim .'</a>
          </li>';
          echo '<li class="breadcrumb-list">
            <div class="dash"></div>
          </li>';
          ...
          ?>
          <?php
          if (!empty($breadcrumb_ag)) {
            echo '<li class="breadcrumb-list">
            <a href="/trademark.php" class="breadcrumb-link-1">'. $breadcrumb_ag .'</a>
          </li>';
          echo '<li class="breadcrumb-list">
            <div class="dash"></div>
          </li>';
          ...
          ?>
          <?php
          if (!empty($breadcrumb_blog)) {
            echo '<li class="breadcrumb-list">
            <a href="/blog.php" class="breadcrumb-link-1">'. $breadcrumb_blog .'</a>
          </li>';
          echo '<li class="breadcrumb-list">
            <div class="dash"></div>
          </li>';
          ...
          ?>
          <li class="breadcrumb-list">
            <a href="#" class="breadcrumb-link-2"><?php echo $page_title ?></a>
          </li>
        </ul>
      </div>
      <!-- /.about-content -->
