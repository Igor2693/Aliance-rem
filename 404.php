  ...
  <section class="section-error">
    <div class="container">
      <div class="error-wrapper">
        <span class="error-big">404</span>
        <div class="error-block">
          <h3 class="error-title">Страница не найдена</h3>
          <p class="error-subtitle">Мы не смогли найти страницу с таким адресом, попробуйте перейти на главную или напишите нам.</p>
          <button  onclick="document.location='index.php'" class="button-error">Вернуться на главную</button>
        </div>
      </div>
    </div>
  </section>
